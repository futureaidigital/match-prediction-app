...
export function RegisterModal({ isOpen, onClose, onSwitchToLogin }: RegisterModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({ email, password, name, country: 'US' }); // Default country
      onClose();
    } catch (err) {
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 md:px-[60px] md:pt-[50px] md:pb-0">
            <button
              onClick={handleBack}
              className="flex items-center gap-1 text-[#0a0a0a] text-[14px] font-medium hover:opacity-70 transition-opacity"
            >
          ...
          {/* Content */}
          <div className="px-4 pb-4 md:px-[60px] md:pb-[50px]">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-[30px]">
              {/* Title */}
              <h2 className="text-[18px] md:text-[22px] font-semibold text-[#0a0a0a] leading-[130%] text-center">
                Create an account
              </h2>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <button
                  type="button"
                  className="w-full h-[40px] bg-[#0d1a67] text-white text-[14px] font-medium rounded-[10px] hover:bg-[#0a1452] transition-colors flex items-center justify-center gap-2"
                >
