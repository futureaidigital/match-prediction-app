          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-12 items-stretch">
            ...
            <div className={`bg-[#0d1a67] rounded-2xl p-5 md:p-8 text-white flex flex-col ${loading ? 'animate-pulse' : ''}`}>
              ...
              <button
                ...
                className="w-full py-2.5 md:py-3 px-4 md:px-6 rounded-lg bg-white text-[#0d1a67] text-sm md:text-base font-semibold hover:bg-gray-100 transition-colors mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={loading || !!error}
              >
                Get Monthly Pro
              </button>
